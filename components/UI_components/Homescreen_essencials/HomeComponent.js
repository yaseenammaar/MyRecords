...
function HomeComponent(props) {
     ...
     *  }
     */
    const {navigation, cardsData, searchBarData, tableData, lan = 'english', fabBtnData} = props
        ...
        <SafeAreaView style={[styles.wrapper, {paddingTop: 0, backgroundColor: "#fff"}]}>
            ...
            <View style={{
                ...
                <View style={[styles.searchFilter, {borderRadius: 30, elevation: 8, backgroundColor: "#fff"}]}>
                    ...
                    <TouchableOpacity style={styles.shopOpen} disabled={mContacts.length <= 0} onPress={() => {
                        print(Prints)
                    }}>
                        ...
                        (
                            <View style={{flex: 1, alignItems: "center", justifyContent: "center", padding: 10}}>
                                <Subheading style={{
                                    padding: 10,
                                    fontWeight: "bold"
                                }}>{"Let's add your First Customer..." }</Subheading>
                                <Button
